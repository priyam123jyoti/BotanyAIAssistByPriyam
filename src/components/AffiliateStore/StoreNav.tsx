...
const storeCategories = [
  ...
  { name: 'Certificates + courses', icon: Award },
  { name: 'Tech & Tabs', icon: Smartphone },
  { name: 'Lab Gear', icon: Microscope },
];

export default function StoreNav({ activeCategory, setActiveCategory }: any) {
  ...
  useEffect(() => {
    ...
    const controls = animate(0, 120, {
      duration: 1.8, // Slightly slower for more premium feel
      ease: "easeInOut",
      onUpdate: (value) => {
