...
export default function WideProductCard({ product }: any) {
  ...
  const shareOnWhatsApp = (e: React.MouseEvent) => {
    e.preventDefault(); // Prevents clicking the card background if wrapped in a link
  ...
  return (
    <div className="group bg-white border border-emerald-100 p-4 md:p-6 flex flex-col md:flex-row gap-6 hover:shadow-2xl hover:shadow-emerald-900/10 transition-all duration-500 relative overflow-hidden">
      
      {/* 1. IMAGE CONTAINER - Added no-referrer fix */}
