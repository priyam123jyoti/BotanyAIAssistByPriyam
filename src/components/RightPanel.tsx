...
function RightPanel() {
  return (
    <div className="h-full">
      ...
      <div className="flex-1 h-full bg-[#050a0a] p-8 text-white shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-emerald-500/10 flex flex-col justify-between relative overflow-hidden">
