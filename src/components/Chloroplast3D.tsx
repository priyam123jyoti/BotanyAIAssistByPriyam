...
export default function Chloroplast3D() {
  ...
  // Prevent background scrolling on phone when maximized
  useEffect(() => {
    if (isFull) {
    ...
    <>
      ...
      <div className="w-full h-full min-h-[400px] rounded-[1rem] overflow-hidden border border-emerald-100 shadow-xl bg-white relative flex flex-col">
        ...
        <button 
          ...
          className="absolute bottom-6 right-6 bg-emerald-900 border-2 border-white text-white p-3 rounded-2xl shadow-2xl flex items-center gap-2 hover:bg-emerald-800 active:scale-95 z-10 border border-emerald-700"
        >
          <Maximize2 size={18} />
