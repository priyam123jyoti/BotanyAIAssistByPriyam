  ...
  return (
    <div className="fixed bottom-24 right-6 z-[100]">
        ...
        {isDenied && (
          ...
          >
            ...
            <button
              ...
              className="w-full py-3 bg-red-600 hover:bg-red-700 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl transition-all flex items-center justify-center gap-2 group/btn shadow-lg shadow-red-900/40"
            >
      ...
      <motion.button
        ...
        className={`relative group flex items-center gap-3 backdrop-blur-xl p-2 pr-6 rounded-full border transition-all duration-500 ${
          isDenied 
