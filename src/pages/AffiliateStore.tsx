...
// Component Imports
import StoreNav from '../components/AffiliateStore/StoreNav';
import WideProductCard from '../components/AffiliateStore/WideProductCard';
import SubFilterNav from '../components/AffiliateStore/SubFilterNav';
import BackToTop from '../components/AffiliateStore/BackToTop';
...
export default function AffiliateStore() {
  ...
  const allFilteredProducts = useMemo(() => {
    return ALL_PRODUCTS.filter((product) => {
      ...
      // Check if sub-category matches either the tag or is included in subjects
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Trigger when user is 150px from the bottom
      if (
  ...
  return (
    <div className="min-h-screen bg-[#fcfdfd] pb-20 font-sans">
      ...
      <main className="max-w-5xl mx-auto px-4 mt-8">
        ...
        {/* AFFILIATE DISCLOSURE (Builds trust & Legal compliance) */}
